...
if ($curentdomain -ne $domainname)
    {{
    $logfolder = "c:\Logs\sqlwitness.log"
    }}
else
    {{    
    $logfolder = "\\$($NIC.DNSServerSearchOrder | Select -First 1)\Logs\sqlwitness.log"
    }}
...
#after config SQL Zone
    ...
    Write-Output "`n:::::::::::::::::::::::::::::::::::::::::::::::::::::"  | Out-File "FileSystem::\\$Using:logfolder" -Append default
    Write-Output "`nSetup SQL Server Witness Finished..." | Out-File "FileSystem::\\$Using:logfolder" -Append default
    Write-Output "`n:::::::::::::::::::::::::::::::::::::::::::::::::::::" | Out-File "FileSystem::\\$Using:logfolder" -Append default 
    Shutdown -l
    }}
}}
...
if ($curentdomain -ne $domainname)
   ...
   if (!(Test-Path "\\$($NIC.DNSServerSearchOrder | Select -First 1)\Logs\sqlwitness.log")) 
       {{
       
       Write-Output "`n::::"   |  Out-File "C:\Logs\sqlwitness.log" -Append default
       Write-Output "`nCopy log file to DC..."   |  Out-File "C:\Logs\sqlwitness.log" -Append default
       Write-Output "`n::::"  |  Out-File "C:\Logs\sqlwitness.log" -Append default
       
       Copy-Item -Path "C:\Logs\sqlwitness.log" -Destination "\\$($NIC.DNSServerSearchOrder | Select -First 1)\Logs\"
       
       Write-Output "`n::::"  |  Out-File "\\$($NIC.DNSServerSearchOrder | Select -First 1)\Logs\sqlwitness.log" -Append default
       Write-Output "`nFile copied..."  |  Out-File "\\$($NIC.DNSServerSearchOrder | Select -First 1)\Logs\sqlwitness.log" -Append default
       Write-Output "`n::::"  |  Out-File "\\$($NIC.DNSServerSearchOrder | Select -First 1)\Logs\sqlwitness.log" -Append default
       }}
   }}
