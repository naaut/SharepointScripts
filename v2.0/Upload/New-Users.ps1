...
New-ADUser -SamAccountName "sp-installer" -UserPrincipalName "sp-installer@$domain" -Name "Installer" -Surname "Farm" -GivenName  "Sharepoint" -DisplayName "Sharepoint Installer" -Path "OU=Accounts,$domainpath" -AccountPassword $password -ChangePasswordAtLogon:$false -PasswordNeverExpires:$true -Enabled:$true -Credential $cred
...
New-ADUser -SamAccountName "sp-serviceapp" -UserPrincipalName "sp-farm@$domain" -Name "Serviceapp"  -Surname "Serviceapp" -GivenName "Sharepoint" -DisplayName "Sharepoint Serviceapp" -Path "OU=Accounts,$domainpath" -AccountPassword $password -ChangePasswordAtLogon:$false -PasswordNeverExpires:$true -Enabled:$true -Credential $cred
