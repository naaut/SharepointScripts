...
if ($env:COMPUTERNAME -ne $newname) {{
  Rename-Computer -Newname $newname -Force -Passthru
      ...
      Write-Output "`n:::::::::::::::::::::::::::::::::::::::::::::::::::::"  | Out-File "C:\Logs\sqlslave.log" -Append
      Write-Output "`nRename Computer Start..." | Out-File "C:\Logs\sqlslave.log" -Append
      Write-Output "`n:::::::::::::::::::::::::::::::::::::::::::::::::::::" | Out-File "C:\Logs\sqlslave.log" -Append
 ...
 if ($curentdomain -ne $domainname){{
    ...
    Write-Output "`n:::::::::::::::::::::::::::::::::::::::::::::::::::::"  | Out-File "C:\Logs\sqlslave.log" -Append
    Write-Output "`nAdd Computer to Domain..." | Out-File "C:\Logs\sqlslave.log" -Append
    Write-Output "`n:::::::::::::::::::::::::::::::::::::::::::::::::::::" | Out-File "C:\Logs\sqlslave.log" -Append  
    ...
    do{{
      try {{
        ...
        Write-Output "`nWait DC...." | Out-File "C:\Logs\sqlslave.log" -Append 
        Start-Sleep 20
        ipconfig /flushdns
        Start-Sleep 20
...
#setup sql server
 ...
 start-job -Name SetupSQLService -ScriptBlock {{    
    ...
    Write-Output "`n:::::::::::::::::::::::::::::::::::::::::::::::::::::"  | Out-File "C:\Logs\sqlslave.log" -Append
    Write-Output "`nSetup firewall and SQL Service account..." | Out-File "C:\Logs\sqlslave.log" -Append
    Write-Output "`n:::::::::::::::::::::::::::::::::::::::::::::::::::::" | Out-File "C:\Logs\sqlslave.log" -Append
 ...
 InlineScript {{
    ...
    Write-Output "`n:::::::::::::::::::::::::::::::::::::::::::::::::::::"  | Out-File "C:\Logs\sqlslave.log" -Append
    Write-Output "`nSetup SQL Server..." | Out-File "C:\Logs\sqlslave.log" -Append
    Write-Output "`n:::::::::::::::::::::::::::::::::::::::::::::::::::::" | Out-File "C:\Logs\sqlslave.log" -Append
    ...
    Write-Output "`n:::::::::::::::::::::::::::::::::::::::::::::::::::::"  | Out-File "C:\Logs\sqlslave.log" -Append
    Write-Output "`nCreate Endpoint..." | Out-File "C:\Logs\sqlslave.log" -Append
    Write-Output "`n:::::::::::::::::::::::::::::::::::::::::::::::::::::" | Out-File "C:\Logs\sqlslave.log" -Append
    ...
    Write-Output "`n:::::::::::::::::::::::::::::::::::::::::::::::::::::"  | Out-File "C:\Logs\sqlslave.log" -Append
    Write-Output "`nSetup Endpoint Rules..." | Out-File "C:\Logs\sqlslave.log" -Append
    Write-Output "`n:::::::::::::::::::::::::::::::::::::::::::::::::::::" | Out-File "C:\Logs\sqlslave.log" -Append
    ...
    Write-Output "`n:::::::::::::::::::::::::::::::::::::::::::::::::::::"  | Out-File "C:\Logs\sqlslave.log" -Append
    Write-Output "`nCreate shared folder for backups..." | Out-File "C:\Logs\sqlslave.log" -Append
    Write-Output "`n:::::::::::::::::::::::::::::::::::::::::::::::::::::" | Out-File "C:\Logs\sqlslave.log" -Append
