...
if ($env:COMPUTERNAME -ne $newname) {{
  Rename-Computer -Newname $newname -Force -Passthru
      ...
      Write-Output "`n:::::::::::::::::::::::::::::::::::::::::::::::::::::"  | Out-File "C:\Logs\frontend.log" -Append
      Write-Output "`nRename Computer Start..." | Out-File "C:\Logs\frontend.log" -Append
      Write-Output "`n:::::::::::::::::::::::::::::::::::::::::::::::::::::" | Out-File "C:\Logs\frontend.log" -Append
 ...
 if ($curentdomain -ne $domainname){{
    InlineScript {{
    Write-Output "`n:::::::::::::::::::::::::::::::::::::::::::::::::::::"  | Out-File "C:\Logs\frontend.log" -Append
    Write-Output "`nAdd to Domain Computer Start..." | Out-File "C:\Logs\frontend.log" -Append
    Write-Output "`n:::::::::::::::::::::::::::::::::::::::::::::::::::::" | Out-File "C:\Logs\frontend.log" -Append    
    ...
    try {{
        ...
        Write-Output "`nWait DC...." | Out-File "C:\Logs\frontend.log" -Append 
        Start-Sleep 20
        ipconfig /flushdns
 ...
 InlineScript {{
    Write-Output "`n:::::::::::::::::::::::::::::::::::::::::::::::::::::"  | Out-File "C:\Logs\frontend.log" -Append
    Write-Output "`nAdd sp-installer and sp-farm to local Administrators group..." | Out-File "C:\Logs\frontend.log" -Append
    Write-Output "`n:::::::::::::::::::::::::::::::::::::::::::::::::::::" | Out-File "C:\Logs\frontend.log" -Append  
 ...
 if (($env:COMPUTERNAME -eq $newname) -and ($curentdomain -eq $domainname) -and ($env:USERDNSDOMAIN -ne $curentdomain)) {{
    ...
    Write-Output "`n:::::::::::::::::::::::::::::::::::::::::::::::::::::"  | Out-File "C:\Logs\frontend.log" -Append
    Write-Output "`nStart External Script for promotion BackEnd Server ..." | Out-File "C:\Logs\frontend.log" -Append
    Write-Output "`n:::::::::::::::::::::::::::::::::::::::::::::::::::::" | Out-File "C:\Logs\frontend.log" -Append 
...
#after all script zone
    InlineScript {{   
    Write-Output "`n:::::::::::::::::::::::::::::::::::::::::::::::::::::"  | Out-File "C:\Logs\frontend.log" -Append
    Write-Output "`nWorkflow completed... please wait external script..."  | Out-File "C:\Logs\frontend.log" -Append
    Write-Output "`n:::::::::::::::::::::::::::::::::::::::::::::::::::::" | Out-File "C:\Logs\frontend.log" -Append
    }}
...
Start-Transcript -Path "c:\Logs\fontend.log" -Append
...
if (!(Test-Path "c:\Scripts\sp-install-frontend.ps1")){{    Write-Output "`n:::::::::::::::::::::::::::::::::::::::::::::::::::::"
    ...
    $source = "http://cubes-scripts.s3.amazonaws.com/v3.0/sp-install-frontend.ps1"    $destination = "c:\Scripts\sp-install-frontend.ps1"     Invoke-WebRequest $source -OutFile $destination
