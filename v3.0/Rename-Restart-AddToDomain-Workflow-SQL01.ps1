...
if ($env:COMPUTERNAME -ne $newname) {{
  Rename-Computer -Newname $newname -Force -Passthru
      ...
      Write-Output "`n:::::::::::::::::::::::::::::::::::::::::::::::::::::"  | Out-File "C:\Logs\sqlmaster.log" -Append
      Write-Output "`nRename Computer Start..." | Out-File "C:\Logs\sqlmaster.log" -Append
      Write-Output "`n:::::::::::::::::::::::::::::::::::::::::::::::::::::" | Out-File "C:\Logs\sqlmaster.log" -Append
 ...
 if ($curentdomain -ne $domainname){{
    ...
    Write-Output "`n:::::::::::::::::::::::::::::::::::::::::::::::::::::"  | Out-File "C:\Logs\sqlmaster.log" -Append
    Write-Output "`nAdd Computer to Domain..." | Out-File "C:\Logs\sqlmaster.log" -Append
    Write-Output "`n:::::::::::::::::::::::::::::::::::::::::::::::::::::" | Out-File "C:\Logs\sqlmaster.log" -Append  
    ...
    do{{
      try {{
        ...
        Write-Output "`nWait DC...." | Out-File "C:\Logs\sqlmaster.log" -Append 
        Start-Sleep 20
        ipconfig /flushdns
...
#setup sql server
 ...
 start-job -Name SetupSQLService -ScriptBlock {{
    ...
    Write-Output "`n:::::::::::::::::::::::::::::::::::::::::::::::::::::"  | Out-File "C:\Logs\sqlmaster.log" -Append
    Write-Output "`nSetup firewall and SQL Service account..." | Out-File "C:\Logs\sqlmaster.log" -Append
    Write-Output "`n:::::::::::::::::::::::::::::::::::::::::::::::::::::" | Out-File "C:\Logs\sqlmaster.log" -Append
 ...
 InlineScript {{
    ...
    Write-Output "`n:::::::::::::::::::::::::::::::::::::::::::::::::::::"  | Out-File "C:\Logs\sqlmaster.log" -Append
    Write-Output "`nSetup SQL Server..." | Out-File "C:\Logs\sqlmaster.log" -Append
    Write-Output "`n:::::::::::::::::::::::::::::::::::::::::::::::::::::" | Out-File "C:\Logs\sqlmaster.log" -Append
    ...
    Write-Output "`n:::::::::::::::::::::::::::::::::::::::::::::::::::::"  | Out-File "C:\Logs\sqlmaster.log" -Append
    Write-Output "`nCreate Endpoint..." | Out-File "C:\Logs\sqlmaster.log" -Append
    Write-Output "`n:::::::::::::::::::::::::::::::::::::::::::::::::::::" | Out-File "C:\Logs\sqlmaster.log" -Append
    ...
    Write-Output "`n:::::::::::::::::::::::::::::::::::::::::::::::::::::"  | Out-File "C:\Logs\sqlmaster.log" -Append
    Write-Output "`nSetup Endpoint Rules..." | Out-File "C:\Logs\sqlmaster.log" -Append
    Write-Output "`n:::::::::::::::::::::::::::::::::::::::::::::::::::::" | Out-File "C:\Logs\sqlmaster.log" -Append
    ...
    Write-Output "`n:::::::::::::::::::::::::::::::::::::::::::::::::::::"  | Out-File "C:\Logs\sqlmaster.log" -Append
    Write-Output "`nCreate shared folder for backups..." | Out-File "C:\Logs\sqlmaster.log" -Append
    Write-Output "`n:::::::::::::::::::::::::::::::::::::::::::::::::::::" | Out-File "C:\Logs\sqlmaster.log" -Append
    ...
    $done=$false
    do{{ 
                if ((Test-Path "c:\SQLBackups\done.txt"))
                    {{
                    #Restart-Service $sqlservice -Force
                    $done=$true
                    }} 
                else {{
                        Date | Out-File "C:\Logs\sqlmaster.log" -Append
                        Write-Output "`n:::::::::::::::::::::::::::::::::::::::::::::::::::::"  | Out-File "C:\Logs\sqlmaster.log" -Append
                        Write-Output "`nWaiting chekpoint file..." | Out-File "C:\Logs\sqlmaster.log" -Append
                        Write-Output "`n:::::::::::::::::::::::::::::::::::::::::::::::::::::" | Out-File "C:\Logs\sqlmaster.log" -Append
                        Start-Sleep 15                        
                     }}
    ...
    Date | Out-File "C:\Logs\sqlmaster.log" -Append    
    Write-Output "`n:::::::::::::::::::::::::::::::::::::::::::::::::::::"  | Out-File "C:\Logs\sqlmaster.log" -Append
    Write-Output "`nStart creating mirooring..." | Out-File "C:\Logs\sqlmaster.log" -Append
    Write-Output "`n:::::::::::::::::::::::::::::::::::::::::::::::::::::" | Out-File "C:\Logs\sqlmaster.log" -Append
    ...
    $dbs = $SQLServer.Databases
      ...
      Date | Out-File "C:\Logs\sqlmaster.log" -Append
      Write-Output "`n:::::::::::::::::::::::::::::::::::::::::::::::::::::"  | Out-File "C:\Logs\sqlmaster.log" -Append
      Write-Output "`nMirroring Setup completed..." | Out-File "C:\Logs\sqlmaster.log" -Append
      Write-Output "`n:::::::::::::::::::::::::::::::::::::::::::::::::::::" | Out-File "C:\Logs\sqlmaster.log" -Append
    }}
...
#after config SQL Zone
    ...
    Write-Output "`n:::::::::::::::::::::::::::::::::::::::::::::::::::::"  | Out-File "C:\Logs\sqlmaster.log" -Append
    Write-Output "`nStart Cleaning..." | Out-File "C:\Logs\sqlmaster.log" -Append
    Write-Output "`n:::::::::::::::::::::::::::::::::::::::::::::::::::::" | Out-File "C:\Logs\sqlmaster.log" -Append
