...
if ($env:COMPUTERNAME -ne $newname) {{
  ...
  InlineScript {{
      Write-Output "`n:::::::::::::::::::::::::::::::::::::::::::::::::::::"  | Out-File "C:\Logs\DC.log" -Append
      Write-Output "`nRename Computer and Create Scheduled Task..." | Out-File "C:\Logs\DC.log" -Append
      Write-Output "`n:::::::::::::::::::::::::::::::::::::::::::::::::::::" | Out-File "C:\Logs\DC.log" -Append
...
if ($env:COMPUTERNAME -like "DC*") {{ 
    ...
    start-job -Name addFeature -ScriptBlock {{
        Write-Output "`n:::::::::::::::::::::::::::::::::::::::::::::::::::::"  | Out-File "C:\Logs\DC.log" -Append
        Write-Output "`nInstall AD DS, DNS and GPMC..." | Out-File "C:\Logs\DC.log" -Append
        Write-Output "`n:::::::::::::::::::::::::::::::::::::::::::::::::::::" | Out-File "C:\Logs\DC.log" -Append
    ...
    if ($env:USERDNSDOMAIN -ne $domainname ) {{
     # Create New Forest, add Domain Controller  
      InlineScript {{          Write-Output "`n:::::::::::::::::::::::::::::::::::::::::::::::::::::"  | Out-File "C:\Logs\DC.log" -Append
          Write-Output "`nCreate and start script dc-promo..." | Out-File "C:\Logs\DC.log" -Append
 ...
 InlineScript {{
    Write-Output "`n:::::::::::::::::::::::::::::::::::::::::::::::::::::"  | Out-File "C:\Logs\DC.log" -Append
    Write-Output "`nStart script for creating new users..." | Out-File "C:\Logs\DC.log" -Append
    Write-Output "`n:::::::::::::::::::::::::::::::::::::::::::::::::::::" | Out-File "C:\Logs\DC.log" -Append
